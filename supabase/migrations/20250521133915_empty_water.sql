/*
  # Add box_weight column to products table
  
  1. Changes
    - Add box_weight column to products table
    - This column stores the weight of a box in kilograms
    - Used for products with unit type 'CX' (box)
    
  2. Description
    - Allows tracking the weight of boxes for shipping and inventory purposes
    - Nullable to support products that don't use box units
*/
