...
BEGIN
  IF NOT EXISTS (
    ...
    AND policyname = 'stock_movements_view_policy_v2'
  ) THEN
    CREATE POLICY "stock_movements_view_policy_v2"
  ...
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE tablename = 'stock_movements' 
    AND policyname = 'stock_movements_insert_policy_v2'
  ) THEN
    CREATE POLICY "stock_movements_insert_policy_v2"
  ...
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE tablename = 'stock_movements' 
    AND policyname = 'stock_movements_update_policy_v2'
  ) THEN
    CREATE POLICY "stock_movements_update_policy_v2"
  ...
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE tablename = 'stock_movements' 
    AND policyname = 'stock_movements_delete_policy_v2'
  ) THEN
    CREATE POLICY "stock_movements_delete_policy_v2"
