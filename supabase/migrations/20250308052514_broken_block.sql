/*
  ...
  1. New Tables
    - `customer_order_links`: For managing external access tokens
  ...
  3. Changes
    - Drop existing policies and tables with CASCADE
...
CREATE POLICY "customer_order_links_admin_access"
...
CREATE POLICY "customer_order_links_public_access"
  ON public.customer_order_links
  FOR SELECT
  TO public
  USING (
...
CREATE POLICY "customer_orders_admin_access"
...
CREATE POLICY "customer_orders_public_create"
  ON public.customer_orders
  FOR INSERT
  TO public
  WITH CHECK (
...
CREATE POLICY "customer_orders_public_read"
  ON public.customer_orders
  FOR SELECT
  TO public
  USING (
...
CREATE POLICY "customer_order_items_admin_access"
...
CREATE POLICY "customer_order_items_public_create"
  ON public.customer_order_items
  FOR INSERT
  TO public
  WITH CHECK (
...
CREATE POLICY "customer_order_items_public_read"
  ON public.customer_order_items
  FOR SELECT
  TO public
  USING (
