/*
  # Security Setup Migration

  1. Changes
    - Drops existing RLS policies
    - Creates master user check function
    - Creates new user handler function and trigger
    - Creates unrestricted policies for master users
    - Enables RLS on all tables
    - Grants necessary permissions

  2. Security
    - Enables RLS on all tables
    - Creates master access policies
    - Sets up proper permission grants
*/
