...
CREATE POLICY "delivery_routes_read"
  ON delivery_routes FOR SELECT
  TO authenticated
  USING (true);

CREATE POLICY "delivery_routes_write"
...
-- Create policies for fiscal_invoices
CREATE POLICY "fiscal_invoices_read"
  ON fiscal_invoices FOR SELECT
  TO authenticated
  USING (true);

CREATE POLICY "fiscal_invoices_write"
