...
DO $$ 
BEGIN
    DROP POLICY IF EXISTS "admin_manager_access_orders" ON customer_orders;
    DROP POLICY IF EXISTS "public_create_orders" ON customer_orders;
    DROP POLICY IF EXISTS "public_read_orders" ON customer_orders;
    DROP POLICY IF EXISTS "admin_manager_access_items" ON customer_order_items;
    DROP POLICY IF EXISTS "public_create_items" ON customer_order_items;
    DROP POLICY IF EXISTS "public_read_items" ON customer_order_items;
EXCEPTION
